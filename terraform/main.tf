locals {
  site_domain      = "${var.site_subdomain}.${var.root_domain_name}"
...
resource "aws_cloudfront_function" "url_rewrite" {
  ...
  publish = true
  code    = file("${path.module}/../infra/cloudfront-url-rewrite.js")
}

resource "aws_cloudfront_distribution" "site" {
  enabled             = true
  is_ipv6_enabled     = true
  comment             = "Static site for ${local.site_domain}"
  aliases             = [local.site_domain, var.root_domain_name]
